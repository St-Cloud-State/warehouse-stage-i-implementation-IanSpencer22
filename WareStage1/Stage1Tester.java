...
public class Stage1Tester {
  ...
  public static void main(String[] s) {
    ...
    // Test adding a new product via user input
    if (yesOrNo("Would you like to add a new product?")) {
      String name = getToken("Enter product name");
      String id = getToken("Enter product id");
      int quantity = Integer.parseInt(getToken("Enter product quantity"));
      warehouse.addProduct(name, id, quantity);
    ...
    // Display waitlist
    System.out.println("Testing waitlist functionality:");
